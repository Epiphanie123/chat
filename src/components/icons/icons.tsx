// A collection of simple SVG icons used in the application.
...
export const CheckAllIcon = ({ read }: { read: boolean }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={read ? '#4ade80' : 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7 13l3 3 7-7" /><path d="M2 13l3 3 7-7" /></svg>
);
